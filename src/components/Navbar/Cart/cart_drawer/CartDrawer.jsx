                    ...
                    <div className="flex flex-col justify-around items-center w-full lg:w-3/4 lg:mx-auto my-1">
                        {
                            ...
                            cartItems.map((prodct,i) => (
                                <div key={i} className="flex flex-row justify-around items-center w-full p-2 my-1">
                                    ...
                                    <div className="flex flex-row justify-around items-center w-12 mx-3">
                                        <i onClick={() => handleQuantityMinus(prodct)} className="fa-sharp fa-solid fa-minus text-sm p-1 cursor-pointer"></i>
                                        <span className="text-xl p-1">{prodct.qty}</span>
                                        <i onClick={() => handleQuantityPlus(prodct)} className="fa-sharp fa-solid fa-plus-large text-sm p-1 cursor-pointer"></i>
                                    </div>
                                    <div className="flex flex-col justify-center items-center">
                                        <span className="text-sm lg:text-lg">{prodct.name}</span>
                                        <p className="text-sm lg:text-base">{prodct.price}</p>
                                        <i onClick={() => handleItemDelete(prodct)} className="fa-sharp fa-solid fa-xmark"></i>
                                    </div>
                                </div>
                            ))
                        }
