    ...
    return(
        <>
            <div className="flex flex-col justify-center items-center w-full my-3 lg:my-4">
                ...
                lg:grid-cols-${wishlist_array.length > 2 ? '2' : wishlist_array.length} 
                ${wishlist_array.length > 2 ? 'lg:grid-rows-2' : ''} 
                ${chevron? 'static translate-x-0 z-0 duration-300' : 'absolute -translate-x-[200px] -z-20 h-0'} lg:my-4
                `}>
                    {  
                        ...
                        :
                        <div className="text-xl my-2 text-center">Nothing in the wishlist :(</div> 
                    }
                </div>
            </div>
        </>
