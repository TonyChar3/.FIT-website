      ...
      >
        <div className="w-full h-auto flex flex-col justify-center items-center">
          ...
          <div
            ...
            className="flex flex-row justify-center items-center bg-black text-white w-[65%] p-4 lg:p-4 rounded-lg lg:w-60 my-4 cursor-pointer active:scale-[0.90] transform-all ease duration-100"
          >
            <span className="w-1/2 flex flex-row justify-end items-center">
              <h3 className="text-2xl">Google</h3>
            </span>
            <span className="w-1/2 flex flex-row justify-end items-center">
              <Chromium size={30} color="#e8dede" />
            </span>
          </div>
          <div
            onClick={FacebookSignIn}
            className="flex flex-row justify-center items-center bg-black text-white w-[65%] p-4 rounded-lg lg:w-60 my-4 cursor-pointer active:scale-[0.90] transform-all ease duration-100"
          >
            <span className="w-1/2 flex flex-row justify-end items-center">
              <h3 className="text-2xl">Facebook</h3>
            </span>
            <span className="w-1/2 flex flex-row justify-end items-center">
              <Facebook size={30} color="#e8dede" />
            </span>
          </div>
        </div>
        <div className="lg:w-[30%] my-4">
          <p className="text-center text-lg lg:text-xl">
            <span className="font-bold">.FIT</span> users have access to our{" "}
            <span className="underline">weekly newsletter</span>,{" "}
            <span className="underline">monthly deals</span> and much much more!
            You will also have access to a wishlist option and NEVER see your
            cart disappear.
          </p>
        </div>
      </motion.div>
