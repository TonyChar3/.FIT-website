    ...
    return(
        <div className="mt-4 mb-[50px]">
            ...
            <div className="flex flex-col justify-center items-center p-2 m-3">
                    ...
                    <div className={`flex flex-row w-80 border-2 ${arrowQ1? '' : 'border-b-0'} border-black w-80 h-[3.8rem]`}>
                        <div className="w-60 text-center flex flex-row justify-center items-center">
                        ...
                        <div className="flex flex-row justify-center items-center border-l-2 border-black w-20">
                            <i onClick={handleQ1chevronClick} className={`fa-sharp fa-solid fa-chevron-up text-xl ${arrowQ1? 'rotate-180' : ''} duration-300`}></i>
                        </div>
                    </div>
                    <div className={`flex flex-row w-full p-2 my-2 justify-center items-center ${arrowQ1? 'static translate-x-0 z-0 h-40 duration-300' : 'absolute -translate-x-[200px] -z-20 h-0'}`}>
                        <span className={`text-center text-lg ${arrowQ1? 'static translate-x-0 w-full z-0 duration-300' : 'relative -translate-x-[200px] w-0 -z-20'}`}>
                    ...
                    <div className={`flex flex-row w-80 border-2 border-black w-80 h-[3.8rem] ${arrowQ2? '' : 'border-b-0'}`}>
                        <div className="w-60 text-center flex flex-row justify-center items-center">
                            <span className="text-lg">How do I care for my apparel?</span>
                        </div>
                        <div className="flex flex-row justify-center items-center border-l-2 border-black w-20">
                            <i onClick={handleQ2chevronClick} className={`fa-sharp fa-solid fa-chevron-up text-xl ${arrowQ2? 'rotate-180' : ''} duration-300`}></i>
                        </div>
                    </div>
                    <div className={`flex flex-row w-full p-2 my-2 justify-center items-center ${arrowQ2? 'static translate-x-0 z-0 h-40 duration-300' : 'absolute -translate-x-[200px] -z-20 h-0'}`}>
                        <span className={`text-center text-lg ${arrowQ2? 'static translate-x-0 w-full z-0 duration-300' : 'relative -translate-x-[200px] w-0 -z-20'}`}>
                    ...
                    <div className={`flex flex-row w-80 border-2 border-black w-80 h-[3.8rem] ${arrowQ3? '' : 'border-b-0'}`}>
                        <div className="w-60 text-center flex flex-row justify-center items-center">
                            <span className="text-lg">How can I track my order?</span>
                        </div>
                        <div className="flex flex-row justify-center items-center border-l-2 border-black w-20">
                            <i onClick={handleQ3chevronClick} className={`fa-sharp fa-solid fa-chevron-up text-xl ${arrowQ3? 'rotate-180' : ''} duration-300`}></i>
                        </div>
                    </div>
                    <div className={`flex flex-row w-full p-2 my-2 justify-center items-center ${arrowQ3? 'static translate-x-0 z-0 h-40 duration-300' : 'absolute -translate-x-[200px] -z-20 h-0'}`}>
                        <span className={`text-center text-lg ${arrowQ3? 'static translate-x-0 w-full z-0 duration-300' : 'relative -translate-x-[200px] w-0 -z-20'}`}>
                    ...
                    <div className={`flex flex-row w-80 border-2 border-black w-80 h-[3.8rem] ${arrowQ4? '' : 'border-b-0'}`}>
                        <div className="w-60 text-center">
                            <span className="text-lg">Do you offer international shipping?</span>
                        </div>
                        
                        <div className="flex flex-row justify-center items-center border-l-2 border-black w-20">
                            <i onClick={handleQ4chevronClick} className={`fa-sharp fa-solid fa-chevron-up text-xl ${arrowQ4? 'rotate-180' : ''} duration-300`}></i>
                        </div>
                    </div>
                    <div className={`flex flex-row w-full p-2 my-2 justify-center items-center ${arrowQ4? 'static translate-x-0 z-0 h-40 duration-300' : 'absolute -translate-x-[200px] -z-20 h-0'}`}>
                        <span className={`text-center text-lg ${arrowQ4? 'static translate-x-0 w-full z-0 duration-300' : 'relative -translate-x-[200px] w-0 -z-20'}`}>
                    ...
                    <div className={`flex flex-row w-80 border-2 border-black w-80 h-[3.8rem]`}>
                        <div className="w-60 text-center">
                            <span className="text-lg">How can I contact customer service?</span>
                        </div>
                        
                        <div className="flex flex-row justify-center items-center border-l-2 border-black w-20"> 
                            <i onClick={handleQ5chevronClick} className={`fa-sharp fa-solid fa-chevron-up text-xl ${arrowQ5? 'rotate-180' : ''} duration-300`}></i>
                        </div>
                    </div>
                    <div className={`flex flex-row w-full p-2 my-2 justify-center items-center ${arrowQ5? 'static translate-x-0 z-0 h-40 duration-300' : 'absolute -translate-x-[200px] -z-20 h-0'}`}>
                        <span className={`text-center text-lg ${arrowQ5? 'static translate-x-0 w-full z-0 duration-300' : 'relative -translate-x-[200px] w-0 -z-20'}`}>
            ...
            <div className="flex flex-row justify-center w-full">
                <motion.button whileTap={{ scale: 0.90 }} whileHover={{ scale: 1.1 }} className="w-40 bg-black text-white p-2 text-xl rounded-xl"><Link to="/contact">Ask a question</Link></motion.button>
            </div>
        </div>
    );
}
