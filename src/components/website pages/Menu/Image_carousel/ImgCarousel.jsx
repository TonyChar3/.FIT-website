        ...
        <>
            <div className="lg:flex lg:flex-row lg:justify-center lg:w-full lg:h-auto">
                <div className="flex justify-center h-2/4 relative overflow-hidden lg:w-1/4 lg:hidden">
                    <img src={images[currentImage]} alt="athlete picture" className="w-full lg:h-1/2"/>
                        
                    <div className="absolute flex flex-row justify-between w-full bottom-1/2">
                        <i onClick={previousImage} className="fa-sharp fa-solid fa-chevron-left text-white text-5xl ml-2 opacity-30 active:scale-[0.90] transform-all ease duration-100"></i>
                        <i onClick={nextImage} className="fa-sharp fa-solid fa-chevron-right text-white text-5xl mr-2 opacity-40 active:scale-[0.90] transform-all ease duration-100"></i>
                    </div>
