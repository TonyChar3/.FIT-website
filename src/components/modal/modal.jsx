    ...
    return(
        <>
            <div className={`h-[5vh] w-64 m-3 absolute right-0 -z-10 ${modalState? '' : '-translate-x-[600px] lg:translate-x-[700px]'} duration-700`}>
                <div className={`${modalState? ' ' : 'bottom-96'}
                flex flex-row justify-center items-center p-2 absolute top-16 lg:top-18 left-0 w-full h-full 
                bg-black rounded-lg shadow-lg border-[1px] border-white break-words duration-300`}>
